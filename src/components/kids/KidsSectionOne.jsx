...
const KidsSectionOne = () => {
  ...
  return (
    <section aria-labelledby="section-title">
      <div className="relative max-w-8xl  md:mx-10 mx-auto px-5 md:px-10 rounded-t-2xl p-3 mt-[-250px]">
        ...
        >
          <article className="flex items-center h-full">
            <div className="p-5 max-w-3xl flex-col justify-start gap-5 inline-flex">
              <h1
                id="section-title"
                className="mt-10   text-[40.77px] font-bold leading-tight max-sm:text-[20px] max-md:text-[27px] max-sm:leading-[34px]  text-white  max-md:text-[black]"
              >
                {t("s1-care")}
              </h1>
              <p className=" text-xl font-normal text-white leading-[34px]">
                <span className="text-white  max-md:text-[black]">
                  {t("s1-in")}
