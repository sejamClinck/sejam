...
const KidsSectionFive = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://sijamdashboard.com/api/send-email",
        {
          method: "POST",
          headers: {
  ...
  return (
    <section>
      <div className="flex flex-col md:flex-row mb-10 overflow-hidden">
        {currentLanguage === "ar" && (
          <div className=" h-[800px] mr-[-30px] w-full hidden lg:flex z-20 mt-[-100px]">
            <img className="w-full mr-5" src={right} alt="" />
          </div>
        )}
        {currentLanguage === "en" && (
          <div className=" h-[800px] mr-[-30px] w-full hidden lg:flex z-20 mt-[-100px]">
            <img className="w-full" src={left} alt="img" />
          </div>
        )}

        <div className=" w-full mx-auto overflow-hidden  z-20 p-5 md:p-0">
          {responseMessage && (
            <div
        ...
        {currentLanguage === "ar" && (
          <div className=" h-[800px] mr-[-30px] w-full hidden lg:flex z-0 mt-[-100px]">
            <img className="w-full" src={left} alt="img" />
          </div>
        )}
        {currentLanguage === "en" && (
