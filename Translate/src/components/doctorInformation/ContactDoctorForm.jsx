...
const ContactDoctorForm = () => {
  ...
  return (
    <div className="max-w-xl mx-auto overflow-hidden p-5">
      <div className="w-[90%] rounded-2xl h-[400px] mb-[-390px] rotate-[5.36deg] bg-white p-5  border border-[#82cddc] z-10"></div>
