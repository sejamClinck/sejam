          ...
          <div className="basis-1/2 p-3 flex items-center justify-between">
            <div className="flex flex-col  gap-3 items-start ">
              ...
              <p
                ...
                role="text"
              >
                <span className=" text-[#eb6a48] text-xs font-semibold font-['Segoe UI'] leading-[19.10px] text-nowrap">
                  {t("experinces")}
                </span>
              </p>
              ...
              <h1
                id="team-section"
                className="self-stretch  text-[#323f47] text-[40px] font-semibold font-['Segoe UI']"
              >
                {t("doctors-team")}
              </h1>
