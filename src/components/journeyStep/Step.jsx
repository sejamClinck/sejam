const Step = ({ number, title, description, imageSrc, altText }) => {
  return (
    <article className="flex flex-col md:flex-row gap-3 my-10 p-3">
      <div className="basis-1/2 flex items-start justify-start">
        <p className="origin-top-left rotate-[-4.34deg]  text-[#eb6a48] text-[81.27px] font-normal font-['Sniglet']">
          {number}
        </p>
        <img
