    ...
    <div className="top flex gap-4 flex-col justify-end sm:justify-center items-center text-center w-[100%] max-h-[250px] h-[400px] relative">
      ...
      <div className="mainBtn flex items-center gap-3 z-10 translate-y-[-20px]">
        <button
          ...
          className="h-10 px-6 py-3 bg-[#eb6a48] rounded-full border border-white flex items-center justify-center text-white text-sm font-normal font-['Segoe UI'] hover:bg-[#d55a3a] transition-colors duration-300"
        ...
        <button
          ...
          className="h-9 px-5 py-2 bg-[#507a8a] rounded-full flex items-center justify-center text-white text-xs font-normal font-['Segoe UI'] hover:bg-[#3f5f6f] transition-colors duration-300"
