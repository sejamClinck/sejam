          ...
          <div className="basis-2/3 p-3 flex items-center justify-start">
            <div className="flex flex-col items-start gap-[20px]">
              <div className="px-[17.84px] py-[6.42px] bg-[#fef4f2] rounded-[51.36px] justify-center items-center gap-2 inline-flex">
                <div className=" text-[#eb6a48] text-xs font-semibold font-['Segoe UI'] leading-[19.10px]">
                {t("s1-tag")}
                </div>
              </div>
              <h2 className="self-stretch  text-[#323f47] text-[40px] font-semibold font-['Segoe UI']">
              {t("s1-title")}
              </h2>
              <p className="self-stretch max-w-[700px]  text-[#3d3d3d] text-base font-normal font-['Segoe UI'] leading-relaxed">
              {t("s1-description")}
              </p>
            </div>
          </div>
