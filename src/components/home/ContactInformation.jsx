...
const ContactItem = ({ icon, label, content, link }) => (
  ...
  <div className="self-stretch justify-end items-start gap-3 inline-flex">
    ...
    <div className="w-full flex-col justify-start items-start gap-6">
      <p className=" text-[#656565] text-base font-normal leading-relaxed">
        {label}
      </p>
      <p className=" text-[#292929] text-xl font-semibold leading-loose">
        {link ? (
    ...
    >
      <div className="w-[391px] flex-col justify-start items-start gap-8 inline-flex max-sm:pr-5">
        <h2
          ...
          className="self-stretch  text-[#7c7c7c] text-[32px] font-semibold leading-[51.20px]"
        >
          {t("s11-contact-info")}
        </h2>
